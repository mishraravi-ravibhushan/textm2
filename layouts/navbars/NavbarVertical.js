      ...
      <SimpleBar style={{ maxHeight: "100vh" }}>
        <div className="nav-scroller">
          <Link href="/" className="navbar-brand">
            <Image src="/images/logo/logo.jpeg" alt="" />
          </Link>
          <i
            style={{
              marginLeft: "96px",
        ...
        >
          {DashboardMenu.map(function (menu, index) {
            if (
              menu.title == "Assets Management" &&
              !btnAsset.includes(jonsUser?.roleName?.toLowerCase())
            ) {
              return true;
            }

            if (
              menu.title == "Surveillance" &&
              !servilance.includes(jonsUser?.roleName?.toLowerCase()) &&
              !servilancedep.includes(jonsUser?.department?.toLowerCase())
            ) {
              return true;
            }

            if (
              menu.title == "Vehicle Management" &&
              !VehicleRole.includes(jonsUser?.roleName?.toLowerCase()) &&
              !VehicleDepart.includes(jonsUser?.department?.toLowerCase())
            ) {
              return true;
            }
