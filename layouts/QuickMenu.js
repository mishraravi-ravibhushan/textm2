...
const QuickMenu = () => {
  ...
  const QuickMenuDesktop = () => {
    ...
    let struser = JSON.parse(storedUser);
    console.log(struser);
    return (
      <ListGroup
        as="ul"
        ...
        <Dropdown as="li" className="ms-2">
          ...
          >
            <div className="avatar avatar-md avatar-indicators avatar-online">
              {storedUser && struser.pic ? (
                <Image
                  src={API_BASE_URL + struser.pic}
                  alt=""
                  width={40}
                  height={40}
                  className="rounded-circle"
          ...
          >
            <Dropdown.Item as="div" className="px-4 pb-0 pt-2" bsPrefix=" ">
              <div className="lh-1 ">
                <h5 className="mb-1">
                  {storedUser ? struser.userName : null}
                  {storedUser ? struser.designation : null}
                </h5>
                <Link href="/home" className="text-inherit fs-6">
                  View my profile
                </Link>
              </div>
